...
class MFPolicyTrainer:
    def __init__(
        ...
        self.early_stop_epoch_number = early_stop_epoch_number
    ...
    def train(self) -> Dict[str, float]:
        ...
        for e in range(1, self._epoch + 1):
            ...
            if e >= self.early_stop_epoch_number:
                break
    ...
    def _evaluate(self) -> Dict[str, List[float]]:
        ...
        while num_episodes < self._eval_episodes:
            ...
            std_per_dim = delta_obs * self.noise_scale
            noise = torch.tensor(np.random.randn(delta_obs.shape[0]), device=std_per_dim.device) * std_per_dim # TODO: using uniform noise
            delta_obs += noise
            obs += delta_obs
            # else:
            #     obs = next_obs
